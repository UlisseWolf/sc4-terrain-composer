...
class Sc4TerrainComposerDock(QDockWidget):
    ...
    def __init__(self, iface, parent=None):
        ...
        self._preview_rubber_band.setColor(Qt.red)
        self._preview_rubber_band.setWidth(2)
        self._preview_rubber_band.setFillColor(Qt.transparent)
    ...
    def refresh_layer_list(self, *_):
        ...
        checked_ids = {
            self.list_layers.item(i).data(Qt.UserRole)
        ...
        for lyr in QgsProject.instance().mapLayers().values():
            ...
            item.setCheckState(Qt.Checked if lyr.id() in checked_ids else Qt.Unchecked)
